    ...
    <header class="entry-header page-header">
        ...
        <?php if ( 'post' == get_post_type() ) : ?>
            <div class="entry-meta">
                <!-- Display the Country", "Genre", "Ticket Price", "Release Date" -->
                <?php
                $args = array('orderby' => 'name', 'order' => 'ASC', 'fields' => 'all');
                $country =  wp_get_post_terms( get_the_ID(), 'country', $args );
                $genre =  wp_get_post_terms( get_the_ID(), 'genre', $args );
                ?>
                Country :
                <?php
                ...
                Release data :
                <?php
                echo get_post_meta(get_the_ID(), 'Release Date', true);
                ?>
            </div><!-- .entry-meta -->
        <?php endif; ?>
    </header><!-- .entry-header -->
